package udpm.hn.server.infrastructure.config.job.student.service.impl;
...
@Service
public class UploadStudentServiceImpl implements UploadStudentService {

    @Value("${file.upload.student.path}")
    public String FILE_UPLOAD_STUDENT_PATH;

    private Path root;

    @PostConstruct
    public void init() {
        root = Paths.get(FILE_UPLOAD_STUDENT_PATH);
        try {
