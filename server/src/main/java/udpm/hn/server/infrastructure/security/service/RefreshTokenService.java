...
import udpm.hn.server.infrastructure.security.repository.RefreshTokenAuthRepository;
...
public class RefreshTokenService {
    ...
    public RefreshToken createRefreshToken(Authentication authentication) {
        ...
        Optional<Staff> staff = staffRepository.findByEmailFpt(userPrincipal.getEmail());
        Optional<Staff> staffFe = staffRepository.findByEmailFe(userPrincipal.getEmail());
