...
import udpm.hn.server.core.superadmin.departments.department.model.response.MajorResponse;
...
@Repository
public interface SAMajorExtendRepository extends MajorRepository {
