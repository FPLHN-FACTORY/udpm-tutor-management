...
import udpm.hn.server.core.superadmin.departments.departmentfacility.model.response.MajorFacilitiesResponse;
import udpm.hn.server.core.superadmin.departments.departmentfacility.model.response.ModifyMajorFacilityResponse;
import udpm.hn.server.core.superadmin.departments.departmentfacility.repository.SADFDepartmentFacilityExtendRepository;
import udpm.hn.server.core.superadmin.departments.departmentfacility.repository.SADFMajorExtendRepository;
import udpm.hn.server.core.superadmin.departments.departmentfacility.repository.SADFStaffExtendRepository;
import udpm.hn.server.core.superadmin.departments.departmentfacility.repository.SaMajorFacilityExtendRepository;
...
@Slf4j
public class SAMajorFacilityServiceImpl implements SAMajorFacilityService {

    private final SaMajorFacilityExtendRepository saMajorFacilityExtendRepository;

    private final SADFDepartmentFacilityExtendRepository departmentFacilityRepository;

    private final SADFStaffExtendRepository staffRepository;

    private final SADFMajorExtendRepository majorRepository;
    ...
    public ResponseObject<?> getAllMajorFacilities(@Valid MajorFacilityRequest request) {
        ...
        try {
            PageableObject<?> listMajorFacility = PageableObject.of(saMajorFacilityExtendRepository.findAllMajorFacilities(request, pageable));
            FacilityDepartmentInfoResponse facilityDepartmentInfo = saMajorFacilityExtendRepository.getFacilityDepartmentInfo(request.getDepartmentFacilityId());
    ...
    public ResponseObject<?> getMajorFacilityById(String majorFacilityId) {
        return saMajorFacilityExtendRepository.findMajorFacilityById(majorFacilityId)
    ...
    public ResponseObject<?> createMajorFacility(@Valid CreateMajorFacilityRequest request) {
        ...
        Optional<MajorFacility> majorFacilityOptional = saMajorFacilityExtendRepository
        ...
        saMajorFacilityExtendRepository.save(majorFacility);
    ...
    public ResponseObject<?> updateMajorFacility(String majorFacilityId, @Valid UpdateMajorFacilityRequest request) {
        Optional<MajorFacility> majorFacilityOptional = saMajorFacilityExtendRepository.findById(majorFacilityId);
    ...
    public ResponseObject<?> synchronize() {
        try {
            ...
            List<MajorFacility> majorFacilities = saMajorFacilityExtendRepository.findAll();
