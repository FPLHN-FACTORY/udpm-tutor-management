...
import udpm.hn.server.core.superadmin.departments.department.repository.SAMajorExtendRepository;
...
public class SAMajorServiceImpl implements SAMajorService {
    ...
    private final SAMajorExtendRepository SAMajorExtendRepository;
    ...
    public ResponseObject<?> getAllMajor(String id, FindMajorRequest request) {
        ...
        return new ResponseObject<>(
                PageableObject.of(SAMajorExtendRepository.getAllMajorByDepartmentIdFilter(id, pageable, request)),
                HttpStatus.OK,
    ...
    public ResponseObject<?> addMajor(@Valid CreateOrUpdateMajorRequest request) {
        ...
        Optional<Major> existsMajor = SAMajorExtendRepository.findMajorByNameAndDepartmentId(request.getMajorName().trim(), request.getDepartmentId());
        Optional<Department> departmentOptional = SADepartmentExtendRepository.findById(request.getDepartmentId());
    ...
    private void syncMajor(Major major, MajorResponse majorResponse) {
        ...
        Department department = SADepartmentExtendRepository.findDepartmentByDepartmentIdentityId(majorResponse.getDepartmentId()).orElse(null);
        if (department == null) {
