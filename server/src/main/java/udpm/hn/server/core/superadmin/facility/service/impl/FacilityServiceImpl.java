package udpm.hn.server.core.superadmin.facility.service.impl;
...
import udpm.hn.server.core.superadmin.facility.model.request.CreateUpdateFacilityRequest;
import udpm.hn.server.core.superadmin.facility.model.request.FacilityRequest;
import udpm.hn.server.core.superadmin.facility.repository.FacilityExtendRepository;
import udpm.hn.server.core.superadmin.facility.repository.SPARoleRepository;
import udpm.hn.server.core.superadmin.facility.service.FacilityService;
...
public class FacilityServiceImpl implements FacilityService {
    ...
    private final SPARoleRepository spaRoleRepository;
    ...
    public ResponseObject<?> createFacility(CreateUpdateFacilityRequest request) {
        ...
        for (int i = 0; i < Role.getAllRoles().size(); i++) {
            udpm.hn.server.entity.Role role = new udpm.hn.server.entity.Role();
            role.setCode(Role.getAllRoles().get(i));
            role.setName(Role.getAllRolesInVietnamese().get(i));
            role.setFacility(facility);
            spaRoleRepository.save(role);
        }
