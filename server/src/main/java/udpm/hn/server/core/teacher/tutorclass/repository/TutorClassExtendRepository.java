...
import udpm.hn.server.core.teacher.tutorclass.model.response.TutorClassResponse;
import udpm.hn.server.repository.TutorClassRepository;

@Repository
public interface TutorClassExtendRepository extends TutorClassRepository {
    ...
    Page<TutorClassResponse> getTutorClassByTeacher(Pageable pageable, TutorClassListRequest request, String teacherId);
