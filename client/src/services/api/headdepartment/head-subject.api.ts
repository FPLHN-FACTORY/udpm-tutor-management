...
export const getHeadOfSubjects = async (
...
export const getStaffByHeadSubject = async (
  ...
  const res = (await request({
    ...
    method: "GET",
    params: params.value,
  })) as AxiosResponse<DefaultResponse<Array<StaffSubjectResponse>>>;
  return res.data;
};
...
export const syncHeadSubjectAttachWithSubjectFromPreviousSemesterToCurrentSemester =
