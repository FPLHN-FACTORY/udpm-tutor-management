...
import { changeStatusFacility, createFacility, CreateUpdateFacilityParams, getDetailFacility, getFacilities, getFacilitySynchronize, ParamsGetFacility, updateFacility } from "@/services/api/superadmin/facility.api";
