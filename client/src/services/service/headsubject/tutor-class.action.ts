  ...
  return useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({
        queryKey: [queryKey.headSubject.plan.tutorList], // Cập nhật key tương ứng nếu cần
      });
    },
    onError: (error) => {
...
export const useUpdateStatusApproveTutorClassHeadSubject = () => {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({
        queryKey: [queryKey.headSubject.plan.tutorList],
      });
    },
    onError: (error) => {
...
export const useGetTutorClass = (
  ...
  return useQuery({
    queryKey: [queryKey.headSubject.plan.tutorList, params],
