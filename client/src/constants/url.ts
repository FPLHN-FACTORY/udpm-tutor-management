...
// HEAD DEPARTMENT API
export const PREFIX_API_HEAD_DEPARTMENT_HEAD_SUBJECT = `${API_URL}/head-department/head-of-subjects` as string;

export const PREFIX_API_HEAD_DEPARTMENT_PLAN = `${API_URL}/head-department/head-of-plans` as string;
