      ...
      <div class="p-5">
        ...
        <div>
          <a-tabs v-model:activeKey="activeKey">
            <a-tab-pane key="1" tab="Kế hoach block 1">Content of Block Pane 1</a-tab-pane>
            <a-tab-pane key="2" tab="Kế hoach block 2" force-render>Content of Block Pane 2</a-tab-pane>
          </a-tabs>
        </div>
      </div>
    </div>
...
console.log(params.value.semesterId);
...
console.log(semesterData.value)
</script>
