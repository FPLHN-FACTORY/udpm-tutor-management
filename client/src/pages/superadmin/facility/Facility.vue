...
import { useDetailFacility, useGetFacility } from '@/services/service/superadmin/facility.action';
import { ParamsGetFacility } from '@/services/api/superadmin/facility.api';
