...
import { ParamsGetDepartment } from "@/services/api/superadmin/department.api";
import {
  MajorResponse,
  ParamsGetMajor,
} from "@/services/api/superadmin/major.api";
import { useGetMajors } from "@/services/service/superadmin/major.action";
...
const {
  data: majorDataResponse,
  isLoading,
  isFetching,
  refetch,
} = useGetMajors(currentDepartmentId, params, {
...
const totalPages = computed(
  () => majorDataResponse?.value?.data?.totalPages || 0
);
