...
import {
  useCreateDepartment,
  useUpdateDepartment,
} from "@/services/service/superadmin/department.action.ts";
...
const handleCreateDepartment = async () => {
  try {
    ...
    console.error("🚀 ~ handleCreateDepartment ~ error:", error);
    toast.error(
      error?.response?.data?.message || ERROR_MESSAGE.SOMETHING_WENT_WRONG
    );
  }
...
const handleUpdateDepartment = async () => {
  try {
    ...
    console.error("🚀 ~ handleUpdateDepartment ~ error:", error);
    toast.error(
      error?.response?.data?.message || ERROR_MESSAGE.SOMETHING_WENT_WRONG
    );
  }
