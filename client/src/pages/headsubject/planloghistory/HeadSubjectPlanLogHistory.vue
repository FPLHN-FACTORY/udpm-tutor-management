<template>
  <div class="mt-4">
    ...
    <head-subject-plan-log-history-filter
        :semesterOptions="semesterOptions"
        :semesterId="userInfo?.semesterId || null"
        :blockId="userInfo?.blockId || null"
        @filter="handleFilter"
    />
    <head-subject-plan-log-history-table
    ...
    />
    <head-subject-plan-log-history-detail
        :open="open"
...
import HeadSubjectPlanLogHistoryTable from './HeadSubjectPlanLogHistoryTable.vue';
import HeadSubjectPlanLogHistoryFilter from './HeadSubjectPlanLogHistoryFilter.vue';
import HeadSubjectPlanLogHistoryDetail from './HeadSubjectPlanLogHistoryDetail.vue';
