<template>
  <div class="mt-4">
    ...
    <head-subject-planner-table :data-source="headSubjectPlannerData" :loading="isLoading || isFetching"
...
import { ParamsGetListPlaner } from "@/services/api/headdepartment/planner.api";
import { useGetDepartmentPlanner } from "@/services/service/headdepartment/planner.action";
...
const { data, isLoading, isFetching } = useGetDepartmentPlanner(params, {
