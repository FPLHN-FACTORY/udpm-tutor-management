...
import { useCreateMajor, useUpdateMajor } from "@/services/service/admin/major.action";
    ...
    Modal.confirm({
        ...
        async onOk() {
            try {
                ...
                const actionParams = props.majorDetail
                    ? {
                ...
                const action = props.majorDetail ? updateMajor : createMajor;
                const message = props.majorDetail ? "Cập nhật chuyên ngành thành công!" : "Tạo chuyên ngành thành công!";
